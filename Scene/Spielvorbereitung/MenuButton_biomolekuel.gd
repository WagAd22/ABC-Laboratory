...
func _ready():
	...
	popup = get_popup()
	# Initialisieren
#	get_node("/root/Main/Startmenu/Popup_Vorbereiten").init_and_load("biomolekuel", popup)
	
# Wenn ein Item angeklickt wird
func _on_item_pressed(ID):
	get_node("/root/Main/Startmenu/Popup_Vorbereiten").item_pressed(ID, "biomolekuel", popup)